	...
	return (
		<div name='home' className='w-full h-screen bg-[#0a192f]'>
			...
			<div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full '>
				...
				<h2 className='text-4xlg sm:text-6xl font-bold text-gray-400'>
				...
				<div>
					<button className='text-white border-2 px-6 py-3 my-2 flex items-center hover:bg-gray-400 hover:text-black'>
